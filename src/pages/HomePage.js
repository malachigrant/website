  ...
  return (
    <Col width={4 / 5}>
      <Card cs={CardStyle}>
        ...
        <p>{`Unfortunately, we get less parallelization with each step we do, with the last step only adding one array element to one other element. But this is still far better than simply sequentially summing up our array, so let's see what kind of results we can get.`}</p>
